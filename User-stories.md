...
- Chaque brouillon affiche une information de durée restante ou une date limite.
- L’utilisateur comprend qu’un brouillon non finalisé est supprimé au bout de 30 jours.
- L’information est visible directement depuis le dashboard ou depuis le brouillon.

---

## EPIC 4 — Création d’un gift

### US-11 — Créer un nouveau gift
...
### US-12 — Choisir le mode de création
...
### US-14 — Rédiger le message principal
...
### US-15 — Ajouter des images selon l’offre
...
### US-17 — Naviguer entre les étapes
...
## EPIC 5 — Offres et limitations

### US-19 — Voir les offres disponibles
...
### US-20 — Comprendre les possibilités incluses
...
### US-21 — Adapter automatiquement les emplacements disponibles
...
## EPIC 6 — Aperçu et validation du contenu
...
### US-23 — Consulter le récapitulatif
...
### US-24 — Vérifier l’ensemble de la configuration

En tant qu’utilisateur, je veux pouvoir consulter dans ce récapitulatif le message, l’offre choisie, les destinataires et les tiers de confiance afin de contrôler l’ensemble de la configuration.  
**Charge (SP) : 2**

**Critères d’acceptation**

- Le récapitulatif liste le message saisi.
- Le récapitulatif affiche l’offre retenue.
- Le récapitulatif affiche les destinataires et les tiers de confiance renseignés.

---

## EPIC 7 — Destinataires et tiers de confiance

### US-25 — Définir les destinataires
...
### US-26 — Définir les tiers de confiance
...
### US-27 — Renseigner les informations nécessaires pour chaque tiers
...
## EPIC 8 — Paiement et validation finale
...
### US-31 — Consulter un dernier aperçu après paiement

En tant qu’utilisateur ayant payé mon gift, je veux pouvoir consulter un dernier aperçu de mon gift afin de confirmer son état final.  
**Charge (SP) : 1**

**Critères d’acceptation**

- Un aperçu du gift finalisé est accessible après paiement.
- L’aperçu reprend les éléments validés lors du parcours.
- L’utilisateur identifie que le gift a bien été finalisé.

---

## EPIC 9 — Édition après création
...
## EPIC 10 — Déclenchement, check-in et escalade
